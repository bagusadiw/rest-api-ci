...
class User extends MY_REST_Controller {
	...
	public function index_post()
	{
		...
		// Set validations
		$this->form_validation->set_rules('name', 'name', 'required|trim|alpha_numeric_spaces|min_length[1]|max_length[50]');
	...
	public function update_put($id = null)
	{
		...
		// Set validations
		$this->form_validation->set_rules('name', 'name', 'alpha_numeric_spaces|trim|min_length[1]|max_length[50]');
